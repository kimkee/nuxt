    ...
    <div class="flex flex-col justify-end absolute left-0 top-0 right-0 bottom-0">
      ...
      <div class="overflow-y-auto">
        <ul class="grid grid-cols-1 p-6 py-8 gap-4">
          <li class="">
            <NuxtLink :to="`./chat/room`" class="border border-gray-300 shadow-sm dark:border-gray-700 bg-white/80 dark:bg-gray-800/70 p-3 pr-8 flex rounded-xl gap-4 items-center relative">
