<template>
    <header class="flex flex-col justify-center min-h-14 safe-top-pd box-content">
      ...
      <div class="flex items-center justify-between safe-top-pd px-5 min-h-14 border-b bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 fixed top-0 left-0 right-0 drop-shadow-sm">
